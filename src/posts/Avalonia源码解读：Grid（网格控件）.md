...
<video style="width: 100%; height: 100%;" id="video" controls="" width=400>
      <source id="mp4" src="@source/posts/assets/Avalonia源码解读：Grid（网格控件）/Grid_1.mp4" type="video/mp4">
</video>
...
<video style="width: 100%; height: 100%;" id="video" controls="" width=400>
      <source id="mp4" src="@source/posts/assets/Avalonia源码解读：Grid（网格控件）/Grid_2.mp4" type="video/mp4">
</video>
